%This calls syn wt update for real and idealized as concentration
clear
close all
clc
...
%vols = [0.255 0.235 0.203 0.026 0.03 0.033 0.643 0.08 0.271 0.119 0.035 0.283 0.058 0.017 0.138 0.034 0.035 0.270 0.272];
...
for i = 1:19
    ...
    for n = 1:1:50
        [t,y] = callsynapticWtsCon(Allca(n,:,i)*molum3touM/(Avo*vols(i)));
        allresults(:,n) = y(:);
...
for i = 1:6
    ...
    for n = 1:1:50
        [t,y] = callsynapticWtsCon(AllcaReal(n,:,i)*molum3touM/(Avo*volsReal(i)));
        allresults(:,n) = y(:);
