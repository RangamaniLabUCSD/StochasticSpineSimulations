%This plots the syn wt vs various geometric
...
% table = table.table;
% 
% tableReal = load('synWtMeanSTD-realistic.mat');
% tableReal = tableReal.table;
% 
...
table = load('ResultsFor400-100-10-10/synWtMeanSTD-IdealReal.mat');
table = table.table;

tableReal = table(20:25,:);
...
synWtAll50 = [synWt(:,1:3) synWt(:,11:25)];% synWtReal];
...
set(0,'defaultAxesFontSize', 28)
set(findall(gca, 'Type', 'Line'),'LineWidth',4);
pngfile = fullfile(pathname, 'synWt-vsVols-wReal-diffColordiffReal-wFit.png');
saveas(gcf, pngfile);
